...
{for(var i = 0, len = gdjs.evtsExt__fade__Fadein.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__fade__Fadein.GDObjectObjects1[i].setOpacity(gdjs.evtsExt__fade__Fadein.GDObjectObjects1[i].getOpacity() - (gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene) * 400));
}
}}
